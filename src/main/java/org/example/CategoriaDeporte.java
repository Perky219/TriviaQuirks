...
public class CategoriaDeporte implements iCategorias {
    private final String nombre = "Deporte";
    private final ArrayList<Partida> partidasActivas = new ArrayList();
    private static CategoriaDeporte instancia;

    public CategoriaDeporte() {
    }

    public static CategoriaDeporte getInstance() {
        return instancia == null ? new CategoriaDeporte() : instancia;
    }
    ...
    public iPregunta obtenerPreguntaAleatoria(int numeroPartida) throws excepcionPreguntasNoDisponibles {
        TriviaPreguntaDeporte[] elementos = TriviaPreguntaDeporte.values();
        ...
        if (numeroDeElementos <= partida.numeroPreguntasRealizadas.size()) {
            ...
            TriviaPreguntaDeporte[] preguntas = TriviaPreguntaDeporte.values();
            TriviaPreguntaDeporte preguntaAleatoria = preguntas[numeroAleatorio];
            ...
            PreguntaDeporte preguntaSolicitada = new PreguntaDeporte(numeroAleatorio, pregunta, respuestaA, respuestaB, respuestaC, respuestaCorrecta);
