...
public class CategoriaTecnologia implements iCategorias {
    private final String nombre = "Tecnologia";
    private final ArrayList<Partida> partidasActivas = new ArrayList();
    private static CategoriaTecnologia instancia;

    public CategoriaTecnologia() {
    }

    public static CategoriaTecnologia getInstance() {
        return instancia == null ? new CategoriaTecnologia() : instancia;
    }
    ...
    public iPregunta obtenerPreguntaAleatoria(int numeroPartida) throws excepcionPreguntasNoDisponibles {
        TriviaPreguntaTecnologia[] elementos = TriviaPreguntaTecnologia.values();
        ...
        if (numeroDeElementos <= partida.numeroPreguntasRealizadas.size()) {
            ...
            TriviaPreguntaTecnologia[] preguntas = TriviaPreguntaTecnologia.values();
            TriviaPreguntaTecnologia preguntaAleatoria = preguntas[numeroAleatorio];
            ...
            PreguntaTecnologia preguntaSolicitada = new PreguntaTecnologia(numeroAleatorio, pregunta, respuestaA, respuestaB, respuestaC, respuestaCorrecta);
